...
<head>
    ...
    <link rel="stylesheet" href="<?php base_url()?>/assets/common/css/danhsachlop.css">
...
<body>
    ...
    <div class="main">
        ...
        <div class="class-container">
            <div class="class__search me-2 d-flex justify-content-end">
            ...
            <div class="class__list p-4 border border-gray rounded-2 m-2 mt-3 shadow-inset">
                <div class="row mb-4">
                    <div class="class__item col-4 col-xxl-4 ">
                        <div class="p-3 border border-gray rounded-2 shadow-sm">
                            <div class="class__item__title mb-5">
                                <h3>Lập trình .NET</h3>
                                <p>Giảng viên: Mai Xuân Hùng</p>
                            </div>
                            <div class="class__item__state">
                                <p>Thời gian: 01/09/2023 - 10/12/2023</p>
                                <p>Trạng thái: <span class="class__item--inprocess">Đang diễn ra</span></p>
                            </div>  
                        </div>
                    </div>
                    <div class="class__item col-4 col-xxl-4 ">
                    ...
                    <div class="class__item col-4 col-xxl-4 ">
                        <div class="p-3 border border-gray rounded-2 shadow-sm">
                            ...
                            <div class="class__item__state">
                                <p>Thời gian: 01/09/2023 - 10/12/2023</p>
                                <p>Trạng thái: <span class="class__item--upcoming">Sắp diễn ra</span></p>
                            </div>  
                        </div>
                    </div>
                </div>
